...
export const ROAD_SEVERITY_CLASSIFICATION = {
    NO_EVENT: ROAD_SEVERITY.MIN,
    VERY_LOW: ROAD_SEVERITY.MIN + ROAD_SEVERITY.STEP * 1,
    LOW: ROAD_SEVERITY.MIN + ROAD_SEVERITY.STEP * 2,
    MEDIUM: ROAD_SEVERITY.MIN + ROAD_SEVERITY.STEP * 3,
    HIGH: ROAD_SEVERITY.MIN + ROAD_SEVERITY.STEP * 4,
    VERY_HIGH: ROAD_SEVERITY.MAX,
}
